...
export const APP_TITLE_PREFFIX = 'RayCoins.info Cryptocurrency Prices, Live Charts, and Market Data';
export const APP_NAME = 'RayCoins.info';
export const APP_MAIL = 'support@raycoins.info';
export const CHANGELLY_REF_ID = '3ynbitfg0s5h4ymu'; //PAST YOUR CHANGELLY REFERAL ID
